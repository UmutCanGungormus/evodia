                                    ...
                                    <div class="row m-b-30">
                                        <div class="col-12">
                                            ...
                                            <form enctype="multipart/form-data" class="form-material" method="POST"
                                                  action="{{route("panel.slider.save")}}">
                                                @csrf
                                                            ...
                                                            <div class="row">
                                                                <div
                                                                    ...
                                                                    <div class="form-group form-default">
                                                                        ...
                                                                        <label class="float-label">Slider Başlığı</label>
                                                                    </div>
                                                                </div>
                                                                <div
                                                                    class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 ">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="form-group form-default">
                                                                        <input type="text"
                                                                               name="url[{{$item->languages->code}}]"
                                                                               class="form-control">
                                                                        <span class="form-bar"></span>
                                                                        <label class="float-label">Slider Linki</label>
                                                                    </div>
                                                                </div>
                                                            </div>
