                                            ...
                                            <div class="tab-pane <?=($key == 0 ? "active" : "")?>"
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                        ...
                                                        <form action="{{route("panel.productImage.fileUpload",$item->languages->code)}}"
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            let table = $('.data-table').DataTable({
                ...
                serverSide: true,
                responsive: true,
                ajax: "{{ route('panel.productImage.datatable',$data->id) }}",
                columns: [
            ...
            table.on('row-reorder', function (e, diff) {
                if (diff.length) {
                    ...
                    $.ajax({
                        method: 'POST',
                        dataType: "json",
                        url: "{{ route("panel.productImage.ranksetter") }}",
                        data: {data}
