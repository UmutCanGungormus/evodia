...
@section("content")
                            ...
                            <div class="card p-5">
                                            ...
                                            <div class="tab-pane <?=($key == 0 ? "active" : "")?>"
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                        {{$item->languages->code}} Dilinde Gösterilecek İçerik
                                                        <form action="{{route("panel.galleryContent.fileUpload",$item->languages->code)}}"
                                                              data-table="data-table"
                                                              class="dropzone"
                                                              id="dropzone-{{$item->languages->code}}">
                                                            @csrf
                                ...
                                <div class="card-header">
                                    <div class="row my-auto py-auto">
                                        <div
                                            class="text-left col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6  my-auto py-auto">
                                            <h5>{{$data->page->title}}</h5>
                                        </div>
                                        <div
                                            class="text-right col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 my-auto py-auto">
                                            <a href="{{route("panel.galleries.add")}}"
    ...
    <div id="content-modal" class="iziModal" data-izimodal-group="alerts"></div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            let table = $('.data-table').DataTable({
                ...
                serverSide: true,
                responsive: true,
                ajax: "{{ route('panel.galleryContent.datatable',$data->id) }}",
                columns: [
                    ...
                    {data: 'id', name: 'id', orderable: true, searchable: true},
                    {
                        ...
                        "render": function (data, type, full, meta) {
                            ...
                            return "<img class='img-fluid' style='max-width:100px' src=\"" + url + "\" height=\"50\"/>";
                        },
                        searchable: true
                    },
                    {data: 'title', name: 'title', orderable: true, searchable: true},
                    {data: 'description', name: 'description', orderable: true, searchable: true},
                    {data: 'lang', name: 'lang', orderable: true, searchable: true},
            ...
            table.on('row-reorder', function (e, diff) {
                if (diff.length) {
                    ...
                    $.ajax({
                        method: 'POST',
                        dataType: "json",
                        url: "{{ route("panel.galleryContent.ranksetter") }}",
                        data: {data}
