                                ...
                                <div class="card-header">
                                    <div class="row my-auto py-auto">
                                        ...
                                        <div class="text-right col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 my-auto py-auto">
                                            <a href="{{route("panel.optionCategory.add")}}" class="btn btn-primary text-right">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            let table = $('.data-table').DataTable({
                ...
                serverSide: true,
                responsive: true,
                ajax: "{{ route('panel.optionCategory.datatable') }}",
                columns: [
            ...
            table.on('row-reorder', function (e, diff) {
                if (diff.length) {
                    ...
                    $.ajax({
                        method: 'POST',
                        dataType: "json",
                        url: "{{ route("panel.optionCategory.ranksetter") }}",
                        data: {data}
