                                    ...
                                    <div class="row m-b-30">
                                        <div class="col-12">
                                            ...
                                            <form enctype="multipart/form-data" class="form-material" method="POST"
                                                  action="{{route("panel.option.update",$data->item->id)}}">
                                                @csrf
                                                        ...
                                                        <div class="tab-pane <?=($key == 0 ? "active" : "")?>"
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="form-group form-default">
                                                                        <input type="text"
                                                                               value="{{$data->item->stock->$lang}}"
                                                                               name="stock[{{$lang}}]"
                                                                               class="form-control">
                                                                        <span class="form-bar"></span>
                                                                        <label class="float-label">Varyasyon Stoğu</label>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="form-group form-default">
                                                                        <input type="text"
                                                                               value="{{$data->item->price->$lang}}"
                                                                               name="price[{{$lang}}]"
                                                                               class="form-control">
                                                                        <span class="form-bar"></span>
                                                                        <label class="float-label">Varyasyon Fiyatı</label>
                                                                    </div>
                                                                </div>
                                                                <div
                                                                    class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 ">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group form-default">
                                                                <select name="category_id"
                                                                    ...
                                                                    <option {{($data->item->category_id==$category->id?" selected":"")}} value="{{$category->id}}">{{$category->title}}</option>
                                                                    @endforeach
                                                                </select>
                                                                <label class="float-label">Kategori Seç</label>
