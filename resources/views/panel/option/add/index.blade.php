                                    ...
                                    <div class="row m-b-30">
                                        <div class="col-12">
                                            ...
                                            <form enctype="multipart/form-data" class="form-material" method="POST"
                                                  action="{{route("panel.option.save",$data->id)}}">
                                                @csrf
                                                        ...
                                                        <div class="tab-pane <?=($key == 0 ? "active" : "")?>"
                                                            ...
                                                            <div class="row">
                                                               <div
                                                                    ...
                                                                    <div class="form-group form-default">
                                                                        <input type="text"
                                                                               value="{{old("title[{$item->languages->code}]")}}"
                                                                               name="title[{{$item->languages->code}}]"
                                                                               class="form-control">
                                                                        <span class="form-bar"></span>
                                                                        <label class="float-label">
                                                                            Varyasyon Başlığı</label>
                                                                    </div>
                                                                </div>
                                                                <div
                                                                    class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                                    <div class="form-group form-default">
                                                                        <input type="text"
                                                                               value="{{old("price[{$item->languages->code}]")}}"
                                                                               name="price[{{$item->languages->code}}]"
                                                                               class="form-control">
                                                                        <span class="form-bar"></span>
                                                                        <label class="float-label">
                                                                            Varyasyon Fiyatı</label>
                                                                    </div>
                                                                </div>
                                                                <div
                                                                    class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                                    <div class="form-group form-default">
                                                                        <input type="text"
                                                                               value="{{old("stock[{$item->languages->code}]")}}"
                                                                               name="stock[{{$item->languages->code}}]"
                                                                               class="form-control">
                                                                        <span class="form-bar"></span>
                                                                        <label class="float-label">
                                                                            Varyasyon Stoğu</label>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-6">
                                                                        <input type="file" name="img_url[{{$item->languages->code}}]"
                                                                               data-id="img-inputs-{{$item->languages->code}}"
                                                                               id="img-input-{{$item->languages->code}}"
                                                                               class="form-control img-input">
                                                                    </div>
                                                                    <div class="col-4 d-none" id="img-inputs-{{$item->languages->code}}">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="form-group form-default">
                                                                ...
                                                                <label class="float-label"> Varyasyon
                                                                    Seçiniz</label>
