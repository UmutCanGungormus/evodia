                                    ...
                                    <ul class="currency-dropdown">
                                        ...
                                        <li><a href="javascript:void(0)">{{ $langJson->home->account }}</a>
                                            <ul>
                                                @if (\Session::has('user'))
                                                    <li>
                                                        <a href="{{ route("theme.{$langJson->routes->account}") }}"><i class="fas fa-user-circle"></i>
                                                            {{ $langJson->home->account }}
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route("theme.{$langJson->routes->logout}") }}"><i class="fas fa-sign-out-alt"></i>
                                                            {{ $langJson->home->logout }}
                                                        </a>
                                                    </li>
                                                @else
                                                    <li>
                                                        <a href="{{ route("theme.{$langJson->routes->login}") }}"><i class="fas fa-user"></i>
                                ...
                                <li class="mini-cart">
                                    ...
                                    <div id="cart-render">
                                        ...
                                        <div class="header-cart">
                                                ...
                                                @foreach ($cart as $cartItem)
                                                    <li class="single-cart-item" data-id="{{ $cartItem->id }}">
                                                        ...
                                                        <div class="cart-content">
                                                            ...
                                                            <span class="product-quantity">{{ $cartItem->quantity }}
                                                                ×</span>
                                            ...
                                            <div class="cart-btn">
                                                <a href="{{ route("theme.{$langJson->routes->basket}") }}"><i class="fa fa-shopping-cart"></i>
